...
public class Demo {
    public static void main(String[] args) {
        ...
        Notifier EmailAndSms = new SmsDecorator(base, "+91-1234567890");
        // EmailAndSms.notify("Hi");

        Notifier EmailSMSAndWhatsAPP = new WhatsAppDecorator(EmailAndSms, "+91-1234567890");
        EmailSMSAndWhatsAPP.notify("Hi");
